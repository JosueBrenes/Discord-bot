    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addRoleOption((option) =>
          option
            .setName("role1")
            .setDescription("Mention the first role to add.")
            .setRequired(true),
        )
        .addRoleOption((option) =>
          option
            .setName("role2")
            .setDescription("Mention the second role to add.")
            .setRequired(false),
        )
        .addRoleOption((option) =>
          option
            .setName("role3")
            .setDescription("Mention the third role to add.")
            .setRequired(false),
        )
        .addRoleOption((option) =>
          option
            .setName("role4")
            .setDescription("Mention the fourth role to add.")
            .setRequired(false),
        )
        .addRoleOption((option) =>
          option
            .setName("role5")
            .setDescription("Mention the fifth role to add.")
            .setRequired(false),
        ),
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("delete")
        .setDescription(
          "Delete the auto-role system configured in your server.",
        ),
    ),
...
async function executeDelete(interaction) {
  ...
  if (!data) {
    const embed = new EmbedBuilder()
      .setDescription(
        ":x: The auto-role system is not configured in this server.",
      )
      .setColor("Red");
