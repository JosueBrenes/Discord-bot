    ...
    async execute(interaction) {
        ...
        try {
            ...
            const embedSaveError = new EmbedBuilder()
                ...
                .setDescription('There was an error saving the data. Please try again later.')
                .setTimestamp();
        ...
        user.send({
            embeds: [
                new EmbedBuilder()
                    ...
                    .setDescription(`A warning has been removed from your history in **${interaction.guild.name}**.`)
                    .addFields(
                        { name: 'Reason', value: `\`\`\`${removedWarn.reason}\`\`\``, inline: false },
                        { name: 'Warned By', value: removedWarn.warnedBy, inline: true },
                        { name: 'Date', value: removedWarn.date, inline: true },
                    ...
                    .setFooter({ text: 'This is an automated notice. Please follow the rules and maintain good behavior.' })
                    .setTimestamp()
            ]
