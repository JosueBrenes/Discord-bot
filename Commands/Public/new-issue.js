...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption((option) =>
      option.setName("link").setDescription("The issue link").setRequired(true),
    ),
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setThumbnail(
        "https://upload.wikimedia.org/wikipedia/commons/thumb/3/37/Octicons-mark-github.svg/1024px-Octicons-mark-github.svg.png",
      )
      .setImage("https://media.giphy.com/media/8fS4ZZHkDADlM/giphy.gif")
      .setFooter({
        text: "Thanks for maintaining the project!",
        iconURL:
