...
function detectSpam(message) {
  ...
  const hasRepeatedWords = Object.values(repeatedWords).some(
  ...
  if (hasRepeatedWords) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        "Your message was deleted for sending the same word too many times in a short period.",
      )
      .setTimestamp();
